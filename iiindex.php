...
<div id="header">
    ...
    <nav>
        <ul>
                ...
                <li><a href="php/ComoTrabajamos.php"><i class="fa fa-briefcase"></i> <span data-translate="como_trabajar">¿Quiénes somos?</span></a></li>
    ...
    <div class="form-container sign-up-container">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['RegistrarUsuario'])) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                header("Location:php/ComoTrabajamos.php?Nombre_Cliente=$Nombre_Cliente");
                exit;
            } else {
