...
if (!isset($_SESSION['DNI_Cliente'])) {
    die("Error: No se ha iniciado sesión o no se ha configurado el DNI del cliente.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['botonclicon'])) {
    // Incluir PHPMailer
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="Nombre"></label>
                                    <input type="text" class="Nombre"  id="Nombre" name="Nombre" required value="<?php echo htmlspecialchars($row['Nombre_Cliente']); ?>" readonly required>
                                    
                                </div>
                                <div class="formESPcon">
                                <label for="Apellido"></label>
                                    <input type="text" class="Apellido" id="Apellido" name="Apellido" required value="<?php echo htmlspecialchars($row['Apellido_Cliente']); ?>" readonly required>
                                    
                                </div>
                                <div class="formESPcon">
                                <label for="Correo"></label>
                                    <input type="email" class="Correo" id="Correo" name="Correo" required value="<?php echo htmlspecialchars($row['Correo_Cliente']); ?>" readonly required>
                            ...
                            <div class="botonCon">
                                ...
                                <button type="submit" class="botonESPcon" name="botonclicon">Enviar</button>
                            </div>
                        </div>
